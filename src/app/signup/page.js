  ...
  export default function Signup() {
    ...
    const handleSuccess = async (credentialResponse) => {
      try {
        ...
        const googleUser = await resGoogle.json();
    ...
    return (
      <>
        <section className="relative z-10 overflow-hidden pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px] font-['comfortaa']">
              ...
              <div className="w-full px-4">
                <div className="shadow-three mx-auto max-w-[500px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                  ...
                  <p className="text-center text-base font-medium text-body-color">
                    Already using QuickCover?{" "}
                    <Link href="/signin" className="text-orange-400 font-bold hover:underline">
                      Sign in
                    </Link>
                  </p>
                </div>
